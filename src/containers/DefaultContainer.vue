...
<!--            <SidebarToggler class="d-md-down-none" display="lg" :defaultOpen="true" ref="sidebarDesktop" />-->
            <b-navbar-nav class="ml-auto">
                <b-nav-text v-if="$auth.isAuthenticated" class="px-3 d-none d-sm-inline-block">Welcome, <img v-if="user.supporter" src="@img/icon_supporter.svg"
                                                                                                             alt="Supporter" class="supporter-badge" height="30"
                /> {{ citizen ? citizen.actualHandle.handle : (user.nickname !== null ? user.nickname : user.email.substr(0, user.email.indexOf('@'))) }}
                </b-nav-text>
                <b-nav-text v-if="$auth.isAuthenticated && user.coins > 0" class="px-3 d-none d-sm-inline-block"><img src="@img/coin.svg" title="FM Coins"
                                                                                                                      alt="FM Coins" height="30"
                > {{ user.coins }}
                </b-nav-text>
        ...
        <TheFooter class="font-lg">
            ...
            <b-nav class="ml-auto">
                ...
                <b-nav-item href="https://discord.gg/f6mrA3Y" target="_blank" link-classes="p-2"><i class="fab fa-discord" style="font-size: 1.4rem;"></i>
                </b-nav-item>
                <b-nav-item href="https://github.com/Ioni14/starcitizen-fleet-manager" target="_blank" link-classes="p-2"><i class="fab fa-github"
